...
sealed class BottomNavigationScreens(val route: String, val icon: ImageVector, val label: String) {
    object Home : BottomNavigationScreens(Routes.ListScreen.route, Icons.Filled.Home, "Inici")
    object Favorite : BottomNavigationScreens("favorite", Icons.Filled.Favorite, "Preferits")
}
