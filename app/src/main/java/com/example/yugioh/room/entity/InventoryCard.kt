...
// Función de extensión para convertir YugiohCard a InventoryCard
fun YugiohCard.toInventoryCard(): InventoryCard {
...
// Función de extensión para convertir InventoryCard a YugiohCard
fun InventoryCard.toYugiohCard(): YugiohCard {
    return YugiohCard(
        id = this.id,
        name = this.name,
        type = this.type,
